...
if (!isset($_SESSION['userID']) || empty($_SESSION['userID'])) {
 ...
 // Reset pesananmakanan to 0 when the page loads
 $Reset = "UPDATE status SET Status = 1 WHERE StatusID = 7";
 $conn->query($Reset); // Reset pesananmakanan to 0 when the page loads
 
  // Reset pesananmakanan to 0 when the page loads
 $Resett = "UPDATE status SET Status = 1 WHERE StatusID = 8";
 $conn->query($Resett); // Reset pesananmakanan to 0 when the page loads
