<?php
// Sertakan koneksi dari connection.php
include('../connection.php');

session_start();

// Assuming this is set when the user selects the sales type
$_SESSION['tipe_penjualan'] = 'dinein'; // or 'takeaway'
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Query untuk menyimpan data ke tabel Order_list
    $sql = "UPDATE order_list SET nomormeja = ? WHERE OrderID = ?";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("ii", $nomormeja, $orderID);
...
<body>
    ...
    <div class="containerOrder">
        ...
        <div class="bagiDua">
            ...
            <div class="containerNomorMeja">
                <h2>Masukkan Nomor Meja</h2>
                <form action="dinein.php" method="POST">
                    <div class="table-input-container">
                        <input type="text" name="nomormeja" maxlength="2" placeholder="0 0" class="table-number-input" required>
                    </div>
